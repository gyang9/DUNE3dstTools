...
public:
    ...
    Cube::TGUIManager& GUI() {return *fGUIManager;}

    /// Return a reference to the event change manager.
    Cube::TEventChangeManager& EventChange() {return *fEventChangeManager;}
...
private:
    ...
    static Cube::TEventDisplay* fEventDisplay;
